...
class ResNet18(torchvision.models.resnet.ResNet):
    ...
    def load_sl_official_weights(self, progress=True):
        state_dict = load_state_dict_from_url(torchvision.models.ResNet18_Weights.IMAGENET1K_V1.url, progress=progress)
...
class ResNet34(torchvision.models.resnet.ResNet):
    ...
    def load_sl_official_weights(self, progress=True):
        state_dict = load_state_dict_from_url(torchvision.models.ResNet34_Weights.IMAGENET1K_V1.url, progress=progress)
...
class ResNet50(torchvision.models.resnet.ResNet):
    ...
    def load_sl_official_weights(self, progress=True):
        state_dict = load_state_dict_from_url(torchvision.models.ResNet50_Weights.IMAGENET1K_V1.url, progress=progress)
...
class ResNet101(torchvision.models.resnet.ResNet):
    ...
    def load_sl_official_weights(self, progress=True):
        state_dict = load_state_dict_from_url(torchvision.models.ResNet101_Weights.IMAGENET1K_V1.url, progress=progress)
