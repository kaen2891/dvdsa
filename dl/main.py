...
def set_loader(args):
    ...
    #train_batch_sampler = samplers.MPerClassSampler(train_dataset.targets, m=2, batch_size=args.batch_size, length_before_new_iter=len(train_dataset))
...
def set_model(args):
    ...
    if args.model == 'ast':
        ...
        model = get_backbone_class(args.model)(**kwargs)
    elif args.model in ['hubert_base', 'hubert_large_ll60k', 'wav2vec2_base_960', 'wav2vec2_large_ll60k', 'xls_r_300m', 'xls_r_1b', 'xls_r_2b', 
        'facebook/hubert-base-ls960', 'facebook/hubert-large-ll60k', 'facebook/hubert-xlarge-ll60k', 'facebook/wav2vec2-base', 'facebook/wav2vec2-large', 
        ...
        if args.framework == 's3prl':
            ...
            if args.model in ['wav2vec2_base_960', 'hubert_base', 'wavlm_base', 'data2vec_base_960']:
    ...
    if args.model not in ['ast', 'ssast', 'hubert_base', 'hubert_large_ll60k', 'wav2vec2_base_960', 'wav2vec2_large_ll60k', 'xls_r_300m', 'xls_r_1b', 'xls_r_2b', 
        'facebook/hubert-base-ls960', 'facebook/hubert-large-ll60k', 'facebook/hubert-xlarge-ll60k', 'facebook/wav2vec2-base', 'facebook/wav2vec2-large', 
...
def main():
    ...
    best_model = None
    if args.dataset == 'psychiatry':
        best_acc = [0]  # Specificity, Sensitivity, Score
    ...
    update_json('%s' % args.model_name, best_acc, path=os.path.join(args.save_dir, 'results_hf.json'))
